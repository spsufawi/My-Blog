...
Let's start by two <code>d</code> and <code>r</code>

##dnorm

This <code>dnorm(x, mean = 0, sd = 1, log = FALSE)</code> function simply calculates the result for the value plugged into the probability density distribution.
